...
def do(shop_id,coki):
    url = "http://www.dianping.com/ajax/json/shopDynamic/addFavor?referId={}&favorType=1&favorTags=&_nr_force=1542599170726&callback=NR._JSONPCallback._1542599150168".format(shop_id)
    headers = {
...
#         'Referer': 'http://www.dianping.com/shop/23685200',
